...
public class PoseEstimator extends SubsystemLance {
    ...
    // left.put(6, new Pose2d( new Translation2d(13.6102433, 3.1393908), new
    // Rotation2d(Math.toRadians(30))));
    ...
    // blah
    // blah.add();
    // aprilTagLocations.add(new Pose2d(5.321046, 4.0259,
    ...
    /**
     * Tells the PoseEstimator how much to trust both the odometry and the vision.
     * Higher values indicate less trust for either the swerve states or the vision
     */
    ...
    private void fillMaps() {
        ...
        leftBranchMap.put(11,
                new Pose2d(new Translation2d(12.5075747, 3.1393908), new Rotation2d(Math.toRadians(-30)))); // S6
        // Blue Left
        ...
        rightBranchMap.put(8,
                new Pose2d(new Translation2d(13.6102293, 4.9124092), new Rotation2d(Math.toRadians(150)))); // S3
        rightBranchMap.put(9,
                new Pose2d(new Translation2d(12.5075747, 4.9124092), new Rotation2d(Math.toRadians(210)))); // S2
        rightBranchMap.put(10, new Pose2d(new Translation2d(12.100906, 4.1859), new Rotation2d(Math.toRadians(270)))); // S1
        rightBranchMap.put(11,
                new Pose2d(new Translation2d(12.457658, 3.1693908), new Rotation2d(Math.toRadians(-30)))); // S6
        // Blue Right
        rightBranchMap.put(17,
                new Pose2d(new Translation2d(3.9381227, 3.1393908), new Rotation2d(Math.toRadians(-30)))); // S3
    ...
    public boolean isPoseInsideField(Pose2d pose) {
        if ((pose.getX() > -1.0 && pose.getX() < fieldXDimension + 1.0)
    ...
    // {
    // scoringLocationArray = (isRight ? (DriverStation.getAlliance().get() ==
    // DriverStation.Alliance.Blue ? blueRightBranchLocationArray :
    // redRightBranchLocationArray) : (DriverStation.getAlliance().get() ==
    // DriverStation.Alliance.Blue ? blueLeftBranchLocationArray :
    // redLeftBranchLocationArray));
    // double distance;
    ...
    // for(int b = 0; b < 6; b++)
    // {
    // distance = Math.sqrt(Math.pow(scoringLocationArray[b][0] - aprilTag.getX(),
    // 2.0) + Math.pow(scoringLocationArray[b][1] - aprilTag.getY(), 2.0));
